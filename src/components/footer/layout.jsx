                ...
                <div style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <a style={{ width: "32px", height: "32px;" }} href="www.google.com">
                        <svg width="32" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.5 12C14.2909 12 12.5 13.7909 12.5 16C12.5 18.2091 14.2909 20 16.5 20C18.7091 20 20.5 18.2091 20.5 16C20.5 13.7909 18.7091 12 16.5 12ZM10.5 16C10.5 12.6863 13.1863 10 16.5 10C19.8137 10 22.5 12.6863 22.5 16C22.5 19.3137 19.8137 22 16.5 22C13.1863 22 10.5 19.3137 10.5 16Z" fill="white"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11 5.5C8.23858 5.5 6 7.73858 6 10.5V21.5C6 24.2614 8.23858 26.5 11 26.5H22C24.7614 26.5 27 24.2614 27 21.5V10.5C27 7.73858 24.7614 5.5 22 5.5H11ZM4 10.5C4 6.63401 7.13401 3.5 11 3.5H22C25.866 3.5 29 6.63401 29 10.5V21.5C29 25.366 25.866 28.5 22 28.5H11C7.13401 28.5 4 25.366 4 21.5V10.5Z" fill="white"/>
